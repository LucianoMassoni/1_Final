...
//
//     final infoPelicula = infoPeliculaFromJson(jsonString);

import 'dart:convert';

InfoPelicula infoPeliculaFromJson(String str) => InfoPelicula.fromJson(json.decode(str));

String infoPeliculaToJson(InfoPelicula data) => json.encode(data.toJson());
...
class InfoPelicula {
    ...
    factory InfoPelicula.fromJson(Map<String, dynamic> json) => InfoPelicula(
        adult: json["adult"],
